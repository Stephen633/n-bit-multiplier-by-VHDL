...
HD_PWD='E:/VHDL_project/N_Bit_Multipler/N_Bit_Multipler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_multipler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source n_bit_multipler.tcl
