...
HD_PWD='E:/VHDL_project/N_Bit_Multipler/N_Bit_Multipler.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_multipler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source n_bit_multipler.tcl -notrace
